...
$(document).ready(function () {
    ...
    var r = createCalendar({
        options: { class: "", id: "" },
        data: {
            title: "Ebba and Amaury's Wedding",
    ...
    $("#rsvp-form").on("submit", function (e) {
        ...
        if ("b0e53b10c1f55ede516b240036b88f40" !== MD5($("#invite_code").val()) && "2ac7f43695eb0479d5846bb38eec59cc" !== MD5($("#invite_code").val())) {
            $("#alert-wrapper").html(alert_markup("danger", "<strong>Sorry!</strong> Your invite code is incorrect."));
        } else {
            $.post("https://script.google.com/macros/s/AKfycbyo0rEknln8LedEP3bkONsfOh776IR5lFidLhJFQ6jdvRiH4dKvHZmtoIybvnxpxYr2cA/exec", t)
                .done(function (e) {
                    console.log(e);
                    if ("error" === e.result) {
